      ...
      <nav className="sticky-top navbar navbar-expand-lg">
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarText">
		   ...
		   <a class="nav-link ligh link " href="#" data-bs-toggle="dropdown"> Auctions </a>
		    <ul class="dropdown-menu">
			  <li><a class="nav-link ligh link dropdown-item " href="#" > Live Auctions</a></li>
			  <li><a class="nav-link ligh link dropdown-item" href="#"> Past Results </a></li>
		    </ul>
	   	</li>
